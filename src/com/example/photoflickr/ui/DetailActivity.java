...
public class DetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new DetailPagerAdapter(getSupportFragmentManager(), MainFragement.list.size());
        mPager = (ViewPager) findViewById(R.id.pager);
        mPager.setAdapter(mAdapter);
        mPager.setOffscreenPageLimit(2);
        
		final int extraCurrentItem = getIntent().getIntExtra(MainFragement.EXTRA_ITEM_POSITION, -1);
    ...
    private class DetailPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            return DetailFragement.newInstance(MainFragement.list.get(position), position);
        }
    }
